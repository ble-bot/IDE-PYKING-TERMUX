...
-- Termux Arrow Keys for Buffer Navigation
map("n", "<Left>", function()
  require("nvchad.tabufline").prev()
...
-- NERDTree (nvim-tree) additional mappings
map("n", "<C-b>", "<cmd>NvimTreeToggle<CR>", { desc = "NERDTree Toggle" })
